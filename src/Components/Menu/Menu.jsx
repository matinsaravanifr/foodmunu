...
export default function Menu() {
  ...
  const filteredData = category ? category.items : [];

  return (
    <>
      <nav className="flex w-full items-center justify-center mb-4 relative mt-3">
        <div className="w-[90%] flex items-center justify-center z-10">
          <ul
          ...
          >
            <li
              ...
              onClick={() => setSelectedCategory("پیش غذا")}
            >
            ...
            <li
              className="mr-3 font-bold cursor-pointer"
              onClick={() => setSelectedCategory("غذای اصلی")}
            >
              <span className="flex flex-col justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li
              className="mr-3 font-bold cursor-pointer"
              onClick={() => setSelectedCategory("دسر")}
            >
              <span className="flex flex-col justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li
              className="mr-3 font-bold cursor-pointer"
              onClick={() => setSelectedCategory("نوشیدنی")}
            >
              <span className="flex flex-col justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      {filteredData.map((item) => (
        <Cards key={`${selectedCategory}-${item.id}`} {...item} />
      ))}
    </>
  );
}
